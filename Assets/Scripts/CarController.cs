...
public interface iVehicleController
{
    ...
    GPS Gps { get; set; }
    //float SkidThresh { get; set; }
    float motorForce { get; set; }
    //float steerForce { get; set; }
    //float AntiRollForce { get; set; }
    //bool WasRuttingFL { get; set; }
    //bool WasRuttingFR { get; set; }
    //bool WasSkiddingFL { get; set; }
    //bool WasSkiddingFR { get; set; }
