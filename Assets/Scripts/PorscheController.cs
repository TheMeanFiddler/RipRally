...
public class PorscheController : VehicleController
{
    ...
    public override void Awake()
    {
        ...
        _rb.centerOfMass = new Vector3(0, 0.15f, 0f);
        ...
        kfs = new Keyframe[4]
{
    ...
    void FixedUpdate()
    {
        ...
        //if (frontFrict == frontFrictTarmac) h = h / (1f + GetComponent<Rigidbody>().velocity.magnitude / 30); //The last number: bigger means sharper turns at high speed
...
public class CarMenuPorscheController : PorscheController
{
