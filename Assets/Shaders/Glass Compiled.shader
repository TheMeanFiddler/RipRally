Shader "Custom/Glass Compiled" {
	Properties {
		_Cube("Reflection Cubemap", Cube) = "black" {}
		_Color("Main Color" , Color) = (0.5,0.5,0.5,0.5) 
		_ReflectColor("Reflection Color", Color) = (1,1,1,0.5)
		_TransmissiveColor("TransmissiveColor", Range(0,1) ) = 1
...
void main ()
{
  ...
  tmpvar_18 = mix (vec4(0.0, 0.0, 0.0, 0.0), vec4(1.0, 1.0, 1.0, 1.0), vec4((1.0 - dot (normalize(tmpvar_2), normalize(vec3(0.0, 0.0, 1.0))))));
  mediump vec3 tmpvar_19;
  tmpvar_19 = (((tmpvar_17.xyz + vec3((pow ((((tmpvar_17.x + tmpvar_17.y) + tmpvar_17.z) / 3.0), _HdrPower) * _HdrContrast))) + _Color.xyz) * pow ((((tmpvar_18.x + tmpvar_18.y) + tmpvar_18.z) / 3.0), _TransmissiveColor));
  mediump float tmpvar_20;
  tmpvar_20 = tmpvar_18.x;
  tmpvar_12 = tmpvar_20;
  tmpvar_11 = tmpvar_19;
  mediump float tmpvar_21;
  tmpvar_21 = (_Color.w + (((tmpvar_19.x + tmpvar_19.y) + tmpvar_19.z) / 3.0));
  tmpvar_13 = tmpvar_21;
  ...
  mediump vec4 c_25;
  c_25.xyz = ((((((lightDir_23.z * 0.5) + 0.5) * tmpvar_11) * _LightColor0.xyz) * 2.0) + (_LightColor0.xyz * max (0.0, (pow ((viewDir_24 + vec3(0.0, 0.0, 1.0)).z, (10.0 - _Shininess)) * tmpvar_12))));
  c_25.w = tmpvar_13;
  c_1 = c_25;
...
void surf( in Input IN, inout SurfaceOutput o ) {
    ...
    mediump vec4 c = (texture( _Cube, reflect( IN.worldRefl, vec3( dot( IN.TtoW0, o.Normal), dot( IN.TtoW1, o.Normal), dot( IN.TtoW2, o.Normal)))) * _ReflectColor);
    #line 411
    ...
    mediump vec3 color1 = (((c.xyz + HDR) + _Color.xyz) * pow( (((GlossLerp.x + GlossLerp.y) + GlossLerp.z) / 3.0), _TransmissiveColor));
    #line 415
    o.Specular = _Shininess;
    o.Gloss = GlossLerp.x;
    o.Albedo = color1;
    o.Alpha = (_Color.w + (((color1.x + color1.y) + color1.z) / 3.0));
}
#line 462
...
// FLOW 1 static, 0 dynamic
"vs_4_0
eefieceddobcnhbeknmeighkbfcgmokkmfcebjkkabaaaaaaimahaaaaadaaaaaa
...
dccabaaaafaaaaaaegbabaaaaeaaaaaaegiacaaaaaaaaaaaagaaaaaaogikcaaa
...
void main ()
{
  ...
  tmpvar_14 = (tmpvar_3 - (2.0 * (dot (tmpvar_13, tmpvar_3) * tmpvar_13)));
  lowp vec4 tmpvar_15;
  tmpvar_15 = textureCube (_Cube, tmpvar_14);
  mediump vec4 tmpvar_16;
  tmpvar_16 = (tmpvar_15 * _ReflectColor);
  mediump vec4 tmpvar_17;
  tmpvar_17 = mix (vec4(0.0, 0.0, 0.0, 0.0), vec4(1.0, 1.0, 1.0, 1.0), vec4((1.0 - dot (normalize(tmpvar_2), normalize(vec3(0.0, 0.0, 1.0))))));
  mediump vec3 tmpvar_18;
  tmpvar_18 = (((tmpvar_16.xyz + vec3((pow ((((tmpvar_16.x + tmpvar_16.y) + tmpvar_16.z) / 3.0), _HdrPower) * _HdrContrast))) + _Color.xyz) * pow ((((tmpvar_17.x + tmpvar_17.y) + tmpvar_17.z) / 3.0), _TransmissiveColor));
  tmpvar_11 = tmpvar_18;
  mediump float tmpvar_19;
  tmpvar_19 = (_Color.w + (((tmpvar_18.x + tmpvar_18.y) + tmpvar_18.z) / 3.0));
  tmpvar_12 = tmpvar_19;
...
void main ()
{
  ...
  c_1.xyz = (tmpvar_11 * ((8.0 * tmpvar_20.w) * tmpvar_20.xyz));
  c_1.w = tmpvar_12;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  lightDir_29 = xlv_TEXCOORD4;
  mediump vec3 viewDir_30;
  viewDir_30 = tmpvar_28;
  mediump float atten_31;
  atten_31 = tmpvar_22;
  mediump vec4 c_32;
  c_32.xyz = (((((((lightDir_29.z * 0.5) + 0.5) * tmpvar_11) * _LightColor0.xyz) * atten_31) * 2.0) + ((_LightColor0.xyz * max (0.0, (pow ((viewDir_30 + vec3(0.0, 0.0, 1.0)).z, (10.0 - _Shininess)) * tmpvar_12))) * atten_31));
  c_32.w = tmpvar_13;
  c_1 = c_32;
  c_1.xyz = (c_1.xyz + (tmpvar_11 * xlv_TEXCOORD5));
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  atten_26 = tmpvar_22;
  mediump vec4 c_27;
  c_27.xyz = (((((((lightDir_24.z * 0.5) + 0.5) * tmpvar_11) * _LightColor0.xyz) * atten_26) * 2.0) + ((_LightColor0.xyz * max (0.0, (pow ((viewDir_25 + vec3(0.0, 0.0, 1.0)).z, (10.0 - _Shininess)) * tmpvar_12))) * atten_26));
  c_27.w = tmpvar_13;
  c_1 = c_27;
  c_1.xyz = (c_1.xyz + (tmpvar_11 * xlv_TEXCOORD5));
  gl_FragData[0] = c_1;
...
// FLOW 1 static, 0 dynamic
"vs_4_0

...
void main ()
{
  ...
  tmpvar_20 = tmpvar_25;
  c_1.xyz = (tmpvar_11 * min ((2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD4).xyz), vec3((tmpvar_20 * 2.0))));
  c_1.w = tmpvar_12;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  c_1.xyz = (tmpvar_11 * max (min (tmpvar_22, ((tmpvar_20.x * 2.0) * tmpvar_21.xyz)), (tmpvar_22 * tmpvar_20.x)));
  c_1.w = tmpvar_12;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  shadow_20 = tmpvar_22;
  c_1.xyz = (tmpvar_11 * min ((2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD4).xyz), vec3((shadow_20 * 2.0))));
  c_1.w = tmpvar_12;
  gl_FragData[0] = c_1;
}
...
Program "fp" {
// Fragment combos: 4
//   opengl - ALU: 33 to 44, TEX: 1 to 3
//   d3d9 - ALU: 37 to 49, TEX: 1 to 3
//   d3d11 - ALU: 25 to 38, TEX: 1 to 3, FLOW: 1 to 1
SubProgram "opengl " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "SHADOWS_OFF" }
...
MUL R1.y, R0.w, c[7];
POW R1.y, R1.y, c[5].x;
MAD R0.xyz, R1.y, c[6].x, R0;
DP3 R1.x, fragment.texcoord[0], fragment.texcoord[0];
RSQ R1.x, R1.x;
MAD R0.w, -R1.x, fragment.texcoord[0].z, c[7].z;
ADD R1.z, R0.w, R0.w;
ADD R1.y, R1.z, R0.w;
MUL R1.z, R1.y, c[7].y;
MOV R1.y, c[8].x;
...
MUL R0.xyz, R0, R1.z;
ADD R1.y, R1, -c[4].x;
MAD R1.x, R1, fragment.texcoord[0].z, c[7].z;
POW R1.x, R1.x, R1.y;
MUL R1.x, R0.w, R1;
MAX R1.w, R1.x, c[8].y;
MAD R0.w, fragment.texcoord[4].z, c[7], c[7];
MUL R1.xyz, R0, R0.w;
MUL R2.xyz, R1.w, c[0];
MUL R1.xyz, R1, c[0];
...
MOV R0.x, c[1].w;
ADD R0.y, R0.z, R0;
MAD result.color.w, R0.y, c[7].y, R0.x;
END
...
; 48 ALU, 1 TEX
dcl_cube s0
def c7, 2.00000000, 0.33333334, 1.00000000, 0.50000000
def c8, 10.00000000, 0.00000000, 0, 0
...
add_pp r0.x, r1, r1.y
add_pp r0.x, r0, r1.z
mul_pp r1.w, r0.x, c7.y
pow_pp r0, r1.w, c5.x
dp3_pp r2.x, v0, v0
rsq_pp r0.y, r2.x
mad_pp r1.w, -r0.y, v0.z, c7.z
mad_pp r1.xyz, r0.x, c6.x, r1
add_pp r0.z, r1.w, r1.w
add_pp r0.x, r0.z, r1.w
mul_pp r0.x, r0, c7.y
pow_pp r2, r0.x, c3.x
mov_pp r0.z, c4.x
add_pp r1.xyz, r1, c1
add_pp r2.z, c8.x, -r0
mad_pp r2.y, r0, v0.z, c7.z
pow_pp r0, r2.y, r2.z
mov_pp r0.w, r0.x
mov_pp r0.y, r2.x
...
Float 80 [_TransmissiveColor]
Float 84 [_Shininess]
Float 88 [_HdrPower]
Float 92 [_HdrContrast]
BindCB "$Globals" 0
...
// FLOW 1 static, 0 dynamic
"ps_4_0
eefiecedendgiigjoecadnjghicmnffakhemeoleabaaaaaaiiagaaaaadaaaaaa
...

...

adaaaaaadoaaaaab"
}
...
Float 2 [_TransmissiveColor]
Float 3 [_HdrPower]
Float 4 [_HdrContrast]
SetTexture 0 [_Cube] CUBE
...
RSQ R1.x, R0.w;
MAD R1.x, -R1, fragment.texcoord[0].z, c[5].z;
ADD R1.y, R1.x, R1.x;
ADD R1.x, R1.y, R1;
TEX R0.xyz, R0, texture[0], CUBE;
MUL R0.xyz, R0, c[1];
...
ADD R1.w, R1, R1.z;
MOV R0.w, c[0];
MAD result.color.w, R1, c[5].y, R0;
...
dcl_cube s0
dcl_2d s1
def c5, 2.00000000, 0.33333334, 1.00000000, 8.00000000
dcl_texcoord0 v0.xyz
dcl_texcoord1 v1.xyzw
dcl_texcoord2 v2.xyzw
dcl_texcoord3 v3.xyzw
...
add_pp r0.x, r1, r1.y
add_pp r0.x, r0, r1.z
mad_pp r0.y, -r0, v0.z, c5.z
add_pp r0.z, r0.y, r0.y
mul_pp r0.x, r0, c5.y
add_pp r0.y, r0.z, r0
pow_pp r2, r0.x, c3.x
mul_pp r1.w, r0.y, c5.y
pow_pp r0, r1.w, c2.x
mov_pp r0.y, r2.x
mad_pp r1.xyz, r0.y, c4.x, r1
mov_pp r0.w, r0.x
add_pp r0.xyz, r1, c0
mul_pp r1.xyz, r0, r0.w
texld r0, v4, s1
...
// FLOW 1 static, 0 dynamic
"ps_4_0
eefiecedgemcapiocnijfdjkahilhkclfgfdbfoaabaaaaaagmafaaaaadaaaaaa
...
adaaaaaaaaaaaaaaapaaaaaafdfgfpfegbhcghgfheaaklklfdeieefcemaeaaaa
eaaaaaaabdabaaaafjaaaaaeegiocaaaaaaaaaaaagaaaaaafkaaaaadaagabaaa
...
lcaabaaaaaaaaaaaegaibaaaaaaaaaaaegiicaaaaaaaaaaaaeaaaaaaaaaaaaah
bcaabaaaabaaaaaabkaabaaaaaaaaaaaakaabaaaaaaaaaaadcaaaaakecaabaaa
aaaaaaaackaabaaaaaaaaaaackiacaaaaaaaaaaaaeaaaaaaakaabaaaabaaaaaa
...

...

egacbaaaabaaaaaadoaaaaab"
}
...
RSQ R0.x, R0.x;
MAD R1.x, -R0, fragment.texcoord[0].z, c[7].z;
ADD R0.z, R1.x, R1.x;
MUL R0.y, R0, c[7];
POW R0.y, R0.y, c[5].x;
MAD R2.xyz, R0.y, c[6].x, R2;
ADD R0.z, R0, R1.x;
MUL R0.y, R0.z, c[7];
MOV R1.y, c[8].x;
ADD R2.xyz, R2, c[1];
...
MAD R0.x, R0, fragment.texcoord[0].z, c[7].z;
ADD R1.y, R1, -c[4].x;
POW R1.y, R0.x, R1.y;
MAD R0.x, fragment.texcoord[4].z, c[7].w, c[7].w;
MUL R1.w, R1.x, R1.y;
...
mul_pp r2.x, r0, c7.y
pow_pp r0, r2.x, c5.x
mad_pp r2.w, -r1, v0.z, c7.z
add_pp r0.y, r2.w, r2.w
add_pp r0.w, r0.y, r2
mad_pp r0.xyz, r0.x, c6.x, r1
mul_pp r1.x, r0.w, c7.y
add_pp r2.xyz, r0, c1
pow_pp r0, r1.x, c3.x
mov_pp r0.y, c4.x
mul_pp r2.xyz, r2, r0.x
add_pp r0.z, c8.x, -r0.y
mad_pp r0.y, r1.w, v0.z, c7.z
pow_pp r1, r0.y, r0.z
mov_pp r0.y, r1.x
mul_pp r0.w, r2, r0.y
max_pp r1.x, r0.w, c8.y
mad_pp r0.x, v4.z, c7.w, c7.w
...
Float 144 [_TransmissiveColor]
Float 148 [_Shininess]
Float 152 [_HdrPower]
Float 156 [_HdrContrast]
BindCB "$Globals" 0
...
// FLOW 1 static, 0 dynamic
"ps_4_0
eefiecedofdpokgkgpmgcngaigpjinjbjahpmeacabaaaaaaeaahaaaaadaaaaaa
...

"
}
...
MOV R0.x, c[0].w;
ADD R0.y, R0, R0.z;
MAD result.color.w, R0.y, c[5].y, R0.x;
END
...
dp3_pp r0.w, v0, v0
rsq_pp r0.w, r0.w
mad_pp r1.w, -r0, v0.z, c5.z
add_pp r0.w, r1, r1
add_pp r0.w, r0, r1
mul_pp r0.w, r0, c5.y
pow_pp r3, r0.w, c2.x
mov_pp r0.w, r2.x
mad_pp r1.xyz, r0.w, c4.x, r1
mov_pp r0.w, r3.x
add_pp r1.xyz, r1, c0
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...

...

...
void main ()
{
  ...
  tmpvar_15.x = tmpvar_5.z;
  tmpvar_15.y = tmpvar_6.z;
  tmpvar_15.z = tmpvar_7.z;
  ...
  tmpvar_19 = mix (vec4(0.0, 0.0, 0.0, 0.0), vec4(1.0, 1.0, 1.0, 1.0), vec4((1.0 - dot (normalize(tmpvar_3), normalize(vec3(0.0, 0.0, 1.0))))));
  mediump vec3 tmpvar_20;
  tmpvar_20 = (((tmpvar_18.xyz + vec3((pow ((((tmpvar_18.x + tmpvar_18.y) + tmpvar_18.z) / 3.0), _HdrPower) * _HdrContrast))) + _Color.xyz) * pow ((((tmpvar_19.x + tmpvar_19.y) + tmpvar_19.z) / 3.0), _TransmissiveColor));
  mediump float tmpvar_21;
  tmpvar_21 = tmpvar_19.x;
  tmpvar_13 = tmpvar_21;
  tmpvar_12 = tmpvar_20;
  mediump float tmpvar_22;
  tmpvar_22 = (_Color.w + (((tmpvar_20.x + tmpvar_20.y) + tmpvar_20.z) / 3.0));
  tmpvar_14 = tmpvar_22;
...
void main ()
{
  ...
  viewDir_25 = tmpvar_23;
  mediump vec4 c_26;
  c_26.xyz = ((((((lightDir_24.z * 0.5) + 0.5) * tmpvar_12) * _LightColor0.xyz) * 2.0) + (_LightColor0.xyz * max (0.0, (pow ((viewDir_25 + vec3(0.0, 0.0, 1.0)).z, (10.0 - _Shininess)) * tmpvar_13))));
  c_26.w = tmpvar_14;
  c_1.xyz = c_26.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  lowp vec4 tmpvar_25;
  highp vec2 P_26;
  P_26 = ((xlv_TEXCOORD5.xy / xlv_TEXCOORD5.w) + 0.5);
  tmpvar_25 = texture2D (_LightTexture0, P_26);
  highp float tmpvar_27;
  tmpvar_27 = dot (xlv_TEXCOORD5.xyz, xlv_TEXCOORD5.xyz);
  lowp vec4 tmpvar_28;
  tmpvar_28 = texture2D (_LightTextureB0, vec2(tmpvar_27));
  mediump vec3 lightDir_29;
  lightDir_29 = lightDir_2;
  mediump vec3 viewDir_30;
  viewDir_30 = tmpvar_24;
  mediump float atten_31;
  atten_31 = ((float((xlv_TEXCOORD5.z > 0.0)) * tmpvar_25.w) * tmpvar_28.w);
  mediump vec4 c_32;
...
void main ()
{
  ...
  lowp vec4 tmpvar_27;
  tmpvar_27 = textureCube (_LightTexture0, xlv_TEXCOORD5);
  mediump vec3 lightDir_28;
  lightDir_28 = lightDir_2;
  mediump vec3 viewDir_29;
  viewDir_29 = tmpvar_24;
  mediump float atten_30;
  atten_30 = (tmpvar_26.w * tmpvar_27.w);
  mediump vec4 c_31;
  c_31.xyz = (((((((lightDir_28.z * 0.5) + 0.5) * tmpvar_12) * _LightColor0.xyz) * atten_30) * 2.0) + ((_LightColor0.xyz * max (0.0, (pow ((viewDir_29 + vec3(0.0, 0.0, 1.0)).z, (10.0 - _Shininess)) * tmpvar_13))) * atten_30));
  c_31.w = tmpvar_14;
  c_1.xyz = c_31.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  tmpvar_23 = normalize(xlv_TEXCOORD0);
  lowp vec4 tmpvar_24;
  tmpvar_24 = texture2D (_LightTexture0, xlv_TEXCOORD5);
  ...
  mediump vec4 c_28;
  c_28.xyz = (((((((lightDir_25.z * 0.5) + 0.5) * tmpvar_12) * _LightColor0.xyz) * atten_27) * 2.0) + ((_LightColor0.xyz * max (0.0, (pow ((viewDir_26 + vec3(0.0, 0.0, 1.0)).z, (10.0 - _Shininess)) * tmpvar_13))) * atten_27));
  c_28.w = tmpvar_14;
  c_1.xyz = c_28.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
Program "fp" {
// Fragment combos: 5
//   opengl - ALU: 37 to 50, TEX: 1 to 3
//   d3d9 - ALU: 44 to 56, TEX: 1 to 3
//   d3d11 - ALU: 31 to 43, TEX: 1 to 3, FLOW: 1 to 1
SubProgram "opengl " {
Keywords { "POINT" }
Vector 0 [_LightColor0]
Vector 1 [_Color]
...
MUL R0.x, R0, c[7].w;
POW R0.w, R0.x, c[5].x;
MAD R1.xyz, R0.w, c[6].x, R1;
DP3 R0.y, fragment.texcoord[0], fragment.texcoord[0];
RSQ R0.y, R0.y;
MAD R0.z, -R0.y, fragment.texcoord[0], c[8].x;
ADD R1.w, R0.z, R0.z;
ADD R0.x, R1.w, R0.z;
MUL R0.x, R0, c[7].w;
POW R0.w, R0.x, c[3].x;
...
MOV R0.x, c[8].y;
ADD R1.w, R0.x, -c[4].x;
MAD R0.x, R0.y, fragment.texcoord[0].z, c[8];
MUL R0.w, R0, fragment.texcoord[4].z;
MAD R0.y, R0.w, c[7], c[7];
POW R0.x, R0.x, R1.w;
MUL R1.xyz, R0.y, R1;
MUL R0.w, R0.z, R0.x;
MUL R0.xyz, R1, c[0];
...
dcl_cube s0
dcl_2d s1
def c7, 0.50000000, 2.00000000, 0.33333334, 1.00000000
def c8, 10.00000000, 0.00000000, 0, 0
dcl_texcoord0 v0.xyz
dcl_texcoord1 v1.xyzw
dcl_texcoord2 v2.xyzw
...
pow_pp r0, r2.y, c3.x
mov_pp r0.y, r2.x
mad_pp r1.xyz, r0.y, c6.x, r1
mov_pp r0.w, r0.x
add_pp r0.xyz, r1, c1
mul_pp r1.xyz, r0, r0.w
mov_pp r0.x, c4
add_pp r2.z, c8.x, -r0.x
mad_pp r2.y, r3.x, v0.z, c7.w
pow_pp r0, r2.y, r2.z
dp3_pp r2.x, v4, v4
rsq_pp r0.y, r2.x
mov_pp r0.w, r0.x
mul_pp r0.y, r0, v4.z
mad_pp r0.x, r0.y, c7, c7
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...

...
diaaaaailcaabaaaaaaaaaaaegaibaaaaaaaaaaaegiicaaaaaaaaaaaaiaaaaaa
aaaaaaahbcaabaaaabaaaaaabkaabaaaaaaaaaaaakaabaaaaaaaaaaadcaaaaak
ecaabaaaaaaaaaaackaabaaaaaaaaaaackiacaaaaaaaaaaaaiaaaaaaakaabaaa
...

...

...
RSQ R0.w, R1.y;
POW R1.y, R1.x, c[5].x;
MAD R1.x, -R0.w, fragment.texcoord[0].z, c[8];
MAD R0.xyz, R1.y, c[6].x, R0;
ADD R1.y, R1.x, R1.x;
ADD R1.y, R1, R1.x;
MUL R1.y, R1, c[7].w;
MAD R0.w, R0, fragment.texcoord[0].z, c[8].x;
ADD R1.z, R1, -c[4].x;
POW R1.z, R0.w, R1.z;
MUL R1.x, R1, R1.z;
POW R0.w, R1.y, c[3].x;
...
MUL R0.xyz, R0, R0.w;
MAX R1.x, R1, c[7];
MAD R0.w, fragment.texcoord[4].z, c[7].y, c[7].y;
MUL R0.xyz, R0.w, R0;
MUL R1.xyz, R1.x, c[0];
MUL R0.xyz, R0, c[0];
MAD result.color.xyz, R0, c[7].z, R1;
...
rsq_pp r0.y, r0.y
mad_pp r1.xyz, r0.x, c6.x, r1
mad_pp r1.w, -r0.y, v0.z, c7
mov_pp r0.z, c4.x
add_pp r0.x, r1.w, r1.w
add_pp r0.x, r0, r1.w
add_pp r2.y, c8.x, -r0.z
mad_pp r2.x, r0.y, v0.z, c7.w
mul_pp r3.x, r0, c7.z
pow_pp r0, r2.x, r2.y
mov_pp r0.y, r0.x
pow_pp r2, r3.x, c3.x
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...
eaaaaaaaddabaaaafjaaaaaeegiocaaaaaaaaaaaagaaaaaafkaaaaadaagabaaa
...

...

...

...
DP3 R0.x, fragment.texcoord[0], fragment.texcoord[0];
RSQ R0.x, R0.x;
MAD R0.y, -R0.x, fragment.texcoord[0].z, c[8].x;
ADD R0.w, R0.y, R0.y;
MUL R0.z, R0, c[7].w;
POW R0.z, R0.z, c[5].x;
MAD R1.xyz, R0.z, c[6].x, R1;
ADD R0.w, R0, R0.y;
MUL R0.z, R0.w, c[7].w;
POW R0.w, R0.z, c[3].x;
ADD R1.xyz, R1, c[1];
...
MOV R0.z, c[8].y;
MUL R0.w, R0, fragment.texcoord[4].z;
MAD R0.x, R0, fragment.texcoord[0].z, c[8];
ADD R0.z, R0, -c[4].x;
POW R0.z, R0.x, R0.z;
MAD R0.x, R0.w, c[7].y, c[7].y;
MUL R1.xyz, R0.x, R1;
MUL R0.w, R0.y, R0.z;
MUL R0.xyz, R1, c[0];
MAX R1.x, R0.w, c[7];
...
SLT R2.x, c[7], fragment.texcoord[5].z;
MUL R1.xyz, R1.x, c[0];
...
dcl_2d s2
def c7, 0.50000000, 2.00000000, 0.33333334, 1.00000000
def c8, 0.00000000, 1.00000000, 10.00000000, 0
dcl_texcoord0 v0.xyz
dcl_texcoord1 v1.xyzw
dcl_texcoord2 v2.xyzw
dcl_texcoord3 v3.xyzw
...
mul_pp r1.xyz, r0, c0
mul_pp r0.w, r1, r0
max_pp r0.y, r0.w, c8.x
rcp r0.x, v5.w
mad r3.xy, v5, r0.x, c7.x
mul_pp r2.xyz, r0.y, c0
dp3 r0.x, v5, v5
texld r0.w, r3, s1
cmp r0.y, -v5.z, c8.x, c8
mul_pp r0.y, r0, r0.w
texld r0.x, r0.x, s2
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...

...

...

...
abaaaaaadkaabaaaaaaaaaaadeaaaaahicaabaaaaaaaaaaadkaabaaaaaaaaaaa
abeaaaaaaaaaaaaadiaaaaaincaabaaaabaaaaaapgapbaaaaaaaaaaaagijcaaa
aaaaaaaaabaaaaaadcaaaaajhccabaaaaaaaaaaaigadbaaaabaaaaaafgafbaaa
...
dp3_pp r0.y, v0, v0
rsq_pp r2.x, r0.y
mad_pp r1.w, -r2.x, v0.z, c7
add_pp r0.x, r1, r1.y
add_pp r0.x, r0, r1.z
mul_pp r2.y, r0.x, c7.z
pow_pp r0, r2.y, c5.x
add_pp r2.z, r1.w, r1.w
add_pp r0.y, r2.z, r1.w
mov_pp r2.y, r0.x
mul_pp r2.z, r0.y, c7
pow_pp r0, r2.z, c3.x
mad_pp r1.xyz, r2.y, c6.x, r1
mov_pp r0.y, c4.x
add_pp r1.xyz, r1, c1
mul_pp r1.xyz, r1, r0.x
add_pp r2.y, c8.x, -r0
mad_pp r2.x, r2, v0.z, c7.w
pow_pp r0, r2.x, r2.y
dp3_pp r0.y, v4, v4
mov_pp r0.z, r0.x
rsq_pp r0.y, r0.y
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...

...

abeaaaaaaaaaaaaadoaaaaab"
}
...
add_pp r1.xyz, r1, c1
add_pp r2.z, c8.x, -r0
mad_pp r2.y, r0, v0.z, c7.w
pow_pp r0, r2.y, r2.z
mov_pp r0.w, r0.x
mov_pp r0.y, r2.x
mul_pp r0.xyz, r1, r0.y
mul_pp r1.x, r1.w, r0.w
mad_pp r0.w, v4.z, c7.x, c7.x
mul_pp r0.xyz, r0.w, r0
max_pp r0.w, r1.x, c8.y
mul_pp r1.xyz, r0.w, c0
texld r0.w, v5, s1
mul_pp r0.xyz, r0, c0
mul_pp r1.xyz, r0.w, r1
mul_pp r0.xyz, r0, r0.w
mad_pp oC0.xyz, r0, c7.y, r1
mov_pp oC0.w, c8.y
"
}
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...
abeaaaaaaaaaaadpdiaaaaahhcaabaaaaaaaaaaaegacbaaaaaaaaaaafgafbaaa
abaaaaaadiaaaaaihcaabaaaaaaaaaaaegacbaaaaaaaaaaaegiccaaaaaaaaaaa
abaaaaaaefaaaaajpcaabaaaacaaaaaaegbabaaaagaaaaaaeghobaaaabaaaaaa
...

